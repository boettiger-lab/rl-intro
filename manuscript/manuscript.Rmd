...
The amount of time needed for an agent to learn high reward yielding behavior cannot be predetermined and depends on a host of factors including the amount of dedicated compute <!-- Kari: is this supposed to be "dedicated compute time"? Not sure what dedicated compute is -->, complexity of the environment, complexity of the agent and more.
...
Rarely do we know the underlying functional forms for ecological processes -- is population recruitment more Beverton-Holt or Ricker? <!-- I don't know what those things are - might not be the place to introduce new concepts even if they're off hand? Or am I the only one that doesn't recognize them? -->
