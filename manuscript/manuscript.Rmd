...
In this brief section, we will introduce the concept of the RL environment as a POMDP; we will then use POMDP definitions to ultimately define the RL objective.
