...
Of course real ecosystems are also far more complex than a game of chess or MoonLander(TM) -- but can the same be said of our efforts at finding the best strategy?
...
Decision-theoretic approaches based on optimal control techniques can only find the best strategy in the simplest of models, the so called "curse of dimensionality" makes problems with too many possible states or actions intractable by conventional methods [@Possingham2006; @Marescot2013].
