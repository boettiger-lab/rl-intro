...
RL agents develop their strategies by interacting with simulators, a practice that should not be unsettling to ecologists since learning from simulators is a common practice.
