...
Critical engagement in the ethical and power issues presented by decision making algorithms will be imperative to ensuring that applications of RL to ecological challenges are fair and just. While widespread discussion of the ethics of decision making algorithms across sectors such as policing, finance, and employment, are a commonplace little has been discussed on the biases and implications of implementing these methods in the environmental context. If algorithms are to play a meaningful role in the allocation and exploitation of natural resources from fish to forests, good intentions [@Joppa] may not be sufficient to ensure equitable outcomes. Mitigation of the power asymmetries that might arise from algorithmic applications are key [cite caleb's paper?]. Engagement with experts in governance and ethics to ensure that applications of AI to ecological challenges are applied responsibly and transparently.
