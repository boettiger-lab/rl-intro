...
nocite: |
    @A2C, @trpo, @ddpg, @TD3, @impala, @lenz_deepmpc_2015, @weber_imagination-augmented_2018
header-includes:
  - \usepackage{amsmath}
  - \usepackage{amssymb}
output: 
...
Decision-theoretic approaches based on optimal control techniques can only find the best strategy in the simplest of ecological models; the so called "curse of dimensionality" makes problems with a large number of states or actions intractable by conventional methods [@Possingham2006; @Marescot2013; @ferrer-mestres_k-n-momdps_2021].
...
\hline
D-MPC        & Deep Model-Predictive Control (Lenz, Knepper, and Saxena 2015)    & Model-based \\
