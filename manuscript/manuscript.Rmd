...
- Will using deep RL create power assymetries between those developing the RL agents and those that rely on the natural resources at stake? 
...
Such benchmarks may further improve collaboration across disciplines as well, attracting the attention of AI expertise to key issues facing our planet.
It is clear that the scientific community needs to develop more powerful methods for our current environmental crises. 
For decision-making in conservation, deep reinforcement learning has the potential to be a paradigm-shifting tool.
