...
<!-- ML: need to change some of the language here to be consistent with POMDP set up later-->
...
<!-- ML: I think we can keep the bias-variance discussion in the appendix and cut these 2 sentences-->
...
<!-- ML: I'm have some uneasiness about this figure. Is A2C tuned? I think we'd probably want to do tuning and training with a set seed so that everything is reproducible?  -->
...
<!-- ML: I think it might be confusing to introduce RNNs, maybe just say different architectures, maybe make a footnote-->
...
The model-free RL agent needs to make no such a priori hypothesis about a particular functional form. <!-- ML: I feel like the remaining part of this dont full drive home the benefit of model-free rl, like its able to learn good performing policies even in the case when a model is very difficult or impossible to learn. -->
...
<!-- ML: I think this needs to be tightened up a bit-->
...
<!-- ML: Re our OU talk, might be worth saying that this is a barrier to adoption? If we want to ultimately use these RL agents to make important decisions, it would be hard to swallow us blindly using them without having any sense to what is going on. -->
Interpretability is a common challenge at the adoption of most ML methods [@cite]. 
...
Another challenge is that Deep RL algorithms are very sample inefficient, all though progress is being made to improve this [@cite]. <!-- ML: I think we can cut this sentence, mentionned it in passing earlier-->
-->


<!-- reason 3: reward design -->
<!-- ML: I'll take a pass at this paragraph in a new branch. I think it would be useful to put terms on stuff in here, like reward shaping and reward hacking which we are talking around. -->
...
<!-- ML: I don't know if this paragraph is adding that much. Since we talk about sparsity in reward design, i think we can add a sentence or 2 there that conveys the message here.-->
