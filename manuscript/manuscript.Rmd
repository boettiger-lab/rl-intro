...
Despite relevance to decision making under uncertainty that could make RL uniquely well suited for ecological and conservation problems, RL has not been widely applied to these fields except in behavioral ecology [@yamada_evolution_2020, @wang_reinforcement_2020].
