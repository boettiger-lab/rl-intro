...
abstract: |
  Can machine learning really help us make better decisions about a changing planet?
  ...
  rather than passively modeling observed data, RL is explicitly designed around 
  the actions of an agent who _interacts_ with an environment which is dynamic and uncertain,
  ...
  and conservation challenges, including examples of both a previously solved problem in setting
  fisheries quotas and a previously unsolved problem in managing ecological tipping points.
