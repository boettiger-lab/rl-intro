...
Instead, we have selected example problems to provide ecologists with a greater background to engage in the collaborative development of deep RL-based methods, while also highlighting challenges which ecological problems pose to existing techniques.
