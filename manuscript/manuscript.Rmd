...
This flexibility of RL, for instance, could allow us to use RL agents on our most realistic ecological models such as the individual-based models used in the management of forests and wildfire [@sortie; @wildfire], disease [@covid], marine ecosystems [@ecopath], or global climate change [@dice].


<!-- Solving 'real' problems will be hard -->
Successfully applying RL to complex ecological problems is no easy task.
Even on relatively uncomplicated environments, training an RL agent can be more challenging than expected due to an entanglement of reasons like hyperparameter instability and poor exploration that can be very difficult to resolve [@drlthatmatters].
...
- Will using software-based agents create power assymetries between those developing the agents and those that rely on the natural resources at stake? 
