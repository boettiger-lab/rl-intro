...
Classic RL algorithms, like policy iteration, value iteration and Actor-Critic [@suttonbarto], fail when the state-action space is large, e.g. when the possible states and actions can not be represented in a tractable table [@CITE].
