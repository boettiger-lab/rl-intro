...
\caption{Reinforcement Learning focuses on the repeated feedback of *agent* interacting with an *environment*. The agent performs an action which influences the environment's future *state*.  The agent recieves an observation of the new state and reward from the environment.}
\end{figure}
