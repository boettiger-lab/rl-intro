...
Since most of the recent focus in RL has gone towards model-free algorithms, we will focus on model-free agents throughout the rest of the paper.

<!-- 
- Say that classically TD learning and dynamic program were common approaches to solving RL; but they fail with large state-action spaces
- over past 10 years, neural network based rl algorithms have succeeded on large state-action spaces

- on-policy vs off-policy, exploration vs exploitation

other algorithm tidbits:
- stochastic vs. determinstic 
- all deep rl algorithms are formulated to work on different action/state spaces
-->
