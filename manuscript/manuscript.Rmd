...
Ecological challenges facing the planet today are complex and outcomes are as uncertain and highly consequential.
...
The science of ecological management and quantitative decision-making has a long history [e.g. @Schaefer1954; @Walters1974] and remains an active area of research [@Possignham2006; @Fischer2009; @Polasky2011].
<!-- Something about influence of natural resource economics and preference for analytically tractable optimization -->
However, the limitations of classical methods such as optimal control frequently constrain these 


In this paper, we have highlighted the great potential that Reinforcement Learning, and in particular, of model-free *deep* RL has for helping confront challenging ecological and environmental management issues in a changing world.
