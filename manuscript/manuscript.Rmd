...
However, the fields of ecology and conservation science have largely overlooked the third and possibly most promising approach in the ML triad: *reinforcement learning* (RL).
...
Despite relevance to decision making under uncertainty that could make RL uniquely well suited for ecological and conservation problems, RL has not been widely applied across these fields except in behavioral ecology [@yamada_evolution_2020, @wang_reinforcement_2020].
...
Yet, model-free algorithms tend to have poor sample efficiency [@sac] which may restrain them from being insightful on simulators that are slow to run. 
