...
<!-- decision theory is a fundamental scientific research topic -->
...
It is much simpler to accommodate these elements and uncertainties in a suite of simulations than it is to solve for the optimal policy.
...
Model-free RL is particularly appealing given the ubiquitous presence of model uncertainty in ecological dynamics.
...
<!-- More precise caveats about reproducibility, convergence, tuning, computational limitations-->
...
Iterative improvements to well-posed public challenges have proven immensely effective in the computer science community in tackling difficult problems [@netflix_prize; @imagenet].
...
<!-- Discuss training across mutiple envs, sequentially vs simultaneously -->


<!-- 
- RL:
  - Focused on decisions
  - more ambitious than other approaches in structured decision-making or other ML
- Limited application, mostly from CS side without sufficient ecological grounding (citation to forest fire work, some )
...
- Way Forward
  Open Competition & Collaboration
  Leaderboards
