...
Some reference to @TomDietrich on potential for CS-based application.
...
Methods from _optimal control theory_ have long been used in conservation and resource economics literature [@Clark1990] to determine optimal policies given such models [@Polasky2011].
...
The examples presented here only scrape the surface of possible RL applicaations to conservation problems.
...
Despite their simplicity, the optimal strategy is not always obvious before hand, however intutive it may appear in retrospect.
