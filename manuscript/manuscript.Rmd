...
According to the algorithm that the agent follows, the agent will explore different state-action trajectories and use its experience to improve its policy.
