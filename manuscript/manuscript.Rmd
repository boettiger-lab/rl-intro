...
There is a handful of advantages and disadvantages for each of these approaches that we will not go in depth on -- for more, see [@CITE]; yet, the main point of distinction comes from the bias-variance trade-off.
...
This same process occurs in value learning and actor-critic algorithms, except these agents are adjusting either a value network or both a value and policy network respectively.
