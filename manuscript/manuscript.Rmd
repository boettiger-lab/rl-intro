...
\begin{tabular}{l l }
\hline
Practical Challenges with Deep RL & Description   \\
\hline
   Generalization                   & blah blah  \\
   Intransparency                   & blah blah \\
   Hyperparameter Instability       & blah blah  \\
   Reward Misspecification          & blah blah \\
   Capital Intensive                & blah blah  \\
   Sample Inefficiency              & blah blah \\
   
\hline
\end{tabular}
\caption{Survey of common deep RL Challenges.}
\end{table}
