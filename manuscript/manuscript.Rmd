...
We have developed more OpenAI `gym`'s, which deal with a range of ecological control problems and pose a wider spectrum of difficulty; an active list of these gyms can be found at <https://boettiger-lab.github.io/conservation-gym/>.
Examples of these additional gyms include a wildfire gym and an epidemic gym.
Further, with the fishing and conservation environments we've detailed in this study, we've defined supplementary fishing and conservation environments that implement a variety of models that present more challenging control problems.
