...
Despite relevance to decision making under uncertainty that could make RL uniquely well suited for ecological conservation, RL has only been applied to this field in a few cases [@xu_robust_2021; @silvestro_improving_2022].
