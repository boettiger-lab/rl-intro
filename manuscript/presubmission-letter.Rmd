...
We believe that similar techniques could improve decision-making in managing ecological environments as well. <!-- Having trouble reconciling lines 21-23, trying to say that these simulators are like the grand challenges and given RL's track record of solving intractable decision-making problems, perhaps RL could shed light here? I think having a sentence asserting that RL would use ecological models not replace them would be good somewhere in here.-->
