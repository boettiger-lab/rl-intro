...
Use of "forgo" on line 132 was intentional.
...
Regarding how neural networks can be used, we have attempted to clarify this in the manuscript in lines 150-153:
...
We’ve updated this statement in the introduction (lines 42-43) as we have found a few note-worthy applications in ecology from @xu_robust_2021 and @silvestro_improving_2022.
...
We have updated our description of the discount factor in the manuscript to address these questions in lines 186-187:
...
This is a great question that we have tried to address in the latest revision in lines 244-250:
...
The reviewer here raises a very good point here about employing domain knowledge to reduce computational costs. This is something that we alluded to in lines 409-411:
...
The reviewer raises two important issues here: "What is the appropriate reward function", and "What are the appropriate limitations on the action space". These questions have always been central issues to ecological management and decision-making, and are neither unique to or resolved by RL [@gregory_structured_2012; @conroy_decision_2013]. We have changed some of our language in lines 126-128 to better address the action space question:
...
And we address the difficulty in selecting a reward function in the discussion in lines 399-401:
...
Lines 221-223: “The manager seeks to optimize the net present value (discounted cumulative catch) of a fishery, observing the stock size each year and setting an appropriate harvest quota in response.”

And for the tipping point problem we give a full detailed explanation of the problem from lines 269 to 285. 
