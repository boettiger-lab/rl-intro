...
Rather than seeking to displace process-based models of the past century with opaque machines, we illustrate how we can use such mechanistic models to build realistic simulators that the RL agents will learn from.
