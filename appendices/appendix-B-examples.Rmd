...
<!-- ML: Given recent excursions, we'll probably want to put a deterministic=True flag in here and following sections; also potentially problematic here if the agent crashes the population and restarts. -->
```{r}
for(i in 1:10){
...
Some agents are non-deterministic, so we may want to use replicate draws at each state to get a better picture of the agent's behavior. <!-- ML: This might be interesting -->
