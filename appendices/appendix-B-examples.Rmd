...
ppo_tuned = sb3$PPO("MlpPolicy",
                    ...
                    "use_sde" = TRUE,
                    "policy_kwargs" = list(
                      "net_arch" = list(list(pi=c(64L, 64L), vf=c(64L, 64L))),
...
Whether the RL agent quotas would have truly been sufficient to permit recovery in stock sizes shown in the simulation clearly depends on the accuracy of the underlying simulation.
