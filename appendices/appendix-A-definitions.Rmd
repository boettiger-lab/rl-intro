...
But there a host of problems with getting neural-network-based value-learning agents to work in practice; see @DQN and @ddqn for more insight on these issues.   
...
We have also not given any space to discuss model-based or gradient-free techniques which also warrant attention -- see @mbpo and @deep_neuro for more here.
