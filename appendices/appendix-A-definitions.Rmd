...
A benefit of model-free deep RL over these other approaches is that there has been more of a general focus on model-free deep RL, so there are widely available packages like Stable Baselines and TensorFlow Agents which implement model-free deep RL agents.
...
\begin{figure}
\includegraphics[width=\linewidth]{algorithm_table.pdf}
\caption{Common Deep RL Algorithms. }
\end{figure}
# References
