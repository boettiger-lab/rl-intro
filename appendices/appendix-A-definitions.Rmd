...
The benefit of actor-critic algorithms is that they balance the issues with bias and variance that are common with value-learning and policy gradient methods respectively [@suttonbarto].
...
As mentioned in the manuscript, the exploration vs. exploitation dilemma is an open research problem. 
