...
Note that re-scaling the state space is equivalent to measuring the process in different units, so this does not affect the transition dynamics [@hastings_population_1997].
